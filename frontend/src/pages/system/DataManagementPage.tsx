...
export function DataManagementPage() {
  ...
  return (
    <section className="p-0 m-0 flex h-full flex-col overflow-hidden" style={{ minHeight: 0 }}>
      ...
      <header className="flex shrink-0 items-center justify-between gap-4 border-b border-(--border-soft) bg-(--surface-1) px-6 py-4">
        <div className="flex items-center gap-4">
          <div className="inline-flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-(--accent-soft) text-(--accent)">
            <Database className="h-5 w-5" />
          </div>
          <div>
            <h1 className="text-lg font-semibold tracking-tight text-(--text-primary)">Data Management</h1>
                          <p className="text-xs text-(--text-secondary)">Digital plant model with live operational context</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto bg-(--page-bg) p-6">
