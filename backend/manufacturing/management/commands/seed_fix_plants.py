...
PLANTS = {
    ...
    "SP-01": {
        ...
        "manager_name": "Ana Martinez",
        "manager_email": "ana.martinez@maxonlift.com",
        "manager_phone": "+52 (81) 555-0102",
        "default_calendar": "Standard (Mon-Fri)",
        "default_shift_model": "1-shift (Morning)",
        "week_start_day": "Monday",
        "default_schedule": "Morning Shift",
        "manufacturing_focus": "Harness, Pipes, Assembly",
        "description": "Assembly and fabrication facility supporting main plant production.",
    },
    "WP-01": {
        "name": "Warehouse 15",
