  ...
  return (
    ...
    >
      <div className="h-full overflow-y-auto p-2">
        ...
        {showForm && (
          <div className="mb-3 rounded-lg border border-border/10 bg-card p-3 shadow-md">
        ...
        {filtered.length > 0 && (
          <div className="overflow-x-auto rounded-lg border border-border/10">
            <table className="w-full text-[11px]">
              ...
              <tbody>
                {filtered.map((dept) => (
                  <tr key={dept.id} className="border-t border-border/10 text-foreground transition-colors hover:bg-muted/30">
