...
export function EntityToolbar({
  ...
  if (variant === "splitListDetail") {
    return (
      <div className="flex shrink-0 items-center border-b border-border bg-muted px-0 border-border bg-muted font-['Segoe_UI',system-ui,sans-serif]" style={{ height: 40 }}>
  ...
  return (
    <div className="flex shrink-0 items-center gap-1 border-b border-border bg-muted px-3 border-border bg-muted font-['Segoe_UI',system-ui,sans-serif]" style={{ height: 40 }}>
      {actions}
