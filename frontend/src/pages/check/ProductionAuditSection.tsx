    ...
    return (
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden bg-gradient-to-b from-white/30 to-white/10 dark:from-slate-900/30 dark:to-slate-900/10">
        ...
        <div className="shrink-0 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md border-b border-white/20 dark:border-slate-700/20">
          ...
          {isNew ? (
            <div>
              <div className="px-4 py-2 border-b border-white/20 dark:border-slate-700/20"><h2 className="text-base font-bold text-foreground">New Production Audit</h2></div>
              <div className="flex">
            ...
            <div className="px-4 py-3">
              ...
              <div className="grid grid-cols-4 gap-3 mt-3">
                <div><label className="block text-[10px] font-medium text-muted-foreground mb-0.5">Type</label><div className="h-8 flex items-center px-2 text-sm text-foreground bg-white/30 dark:bg-slate-800/30 border border-white/20 dark:border-slate-700/20">{headerTpl?.name ?? "-"} v{headerTpl?.version ?? ""}</div></div>
