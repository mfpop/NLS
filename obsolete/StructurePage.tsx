...
import {
  ...
  Building2, GitBranch, Monitor, Wrench, Truck, ClipboardCheck,
  AlertTriangle
} from ""lucide-react"";
import { Breadcrumbs, ResourceStatusBadge, LoadBar, SmartControlTowerLink, AlertBanner } from ""./shared"";
...
const structureTree: TreeNode[] = [
    ...
    children: [
      {
        ...
        subtitle: ""3 lines · 2 bottleneck"", loadPct: 78,
        children: [
          {
            id: ""L001"", label: ""C2-Cylinder Assembly"", icon: GitBranch, type: ""line"",
            subtitle: ""Assembly · 4 groups · 18 resources"", loadPct: 94, isBottleneck: true,
            to: ""/system/data-management/plant/P001"",
          },
          {
            id: ""L002"", label: ""Line B (STB Units)"", icon: GitBranch, type: ""line"",
            subtitle: ""Assembly, Machining · 3 groups · 12 resources"", loadPct: 68,
            to: ""/system/data-management/plant/P001"",
          },
          {
            id: ""L003"", label: ""Line C (Pipes)"", icon: GitBranch, type: ""line"",
            subtitle: ""Quality Control · 2 groups · 8 resources"", loadPct: 45,
            to: ""/system/data-management/plant/P001"",
          },
        ],
      },
      {
        id: ""P001-dept"", label: ""Departments"", icon: Layers, type: ""department"",
        subtitle: ""4 departments · 14 resources"",
        children: [
          {
            id: ""D001"", label: ""Assembly"", icon: Building2, type: ""department"",
            subtitle: ""John Smith · 45 emp · 14 resources"", loadPct: 78,
            to: ""/system/data-management/departments/D001"",
            children: [
              {
                id: ""RG001"", label: ""Line Operators"", icon: Users, type: ""group"",
                subtitle: ""Production · 28 members · 12 resources"", loadPct: 85, isBottleneck: true,
                to: ""/system/data-management/resource-groups/RG001"",
                children: [
              ...
              {
                id: ""RG002"", label: ""Setup Technicians"", icon: Users, type: ""group"",
                subtitle: ""Support · 12 members · 6 resources"", loadPct: 62,
                to: ""/system/data-management/resource-groups/RG002"",
                children: [
                  { id: ""RES-CNC-01"", label: ""CNC Mill 1"", icon: Cpu, type: ""resource"", subtitle: ""Machine · CNC-MILL-01"", loadPct: 87, opStatus: ""Running"", to: ""/system/data-management/resources/RES-CNC-01"" },
                ],
              },
            ],
          },
          {
            id: ""D002"", label: ""Machining"", icon: Building2, type: ""department"",
            subtitle: ""Sarah Chen · 32 emp · 10 resources"", loadPct: 92,
            to: ""/system/data-management/departments/D002"",
            children: [
              {
                id: ""RG003"", label: ""Quality Inspectors"", icon: Users, type: ""group"",
                subtitle: ""Quality · 8 members · 5 resources"", loadPct: 42,
                to: ""/system/data-management/resource-groups/RG003"",
                children: [
                  { id: ""RES-QC-01"", label: ""QC Gate 1"", icon: ClipboardCheck, type: ""resource"", subtitle: ""Inspection · QC-GATE-01"", loadPct: 42, opStatus: ""Idle"", to: ""/system/data-management/resources/RES-QC-01"" },
                ],
              },
            ],
          },
  ...
  {
    id: ""P002"", label: ""Secondary Plant"", icon: Factory, type: ""plant"",
    subtitle: ""Building B · 2 lines · 18 resources"", loadPct: 45,
    ...
    children: [
      {
        ...
        children: [
          {
            id: ""D004b"", label: ""Logistics"", icon: Building2, type: ""department"",
            subtitle: ""Ana Garcia · 22 emp · 12 resources"", loadPct: 65,
            to: ""/system/data-management/departments/D004"",
            children: [
              {
                id: ""RG004"", label: ""Material Handlers"", icon: Users, type: ""group"",
                subtitle: ""Logistics · 15 members · 8 resources"", loadPct: 72,
                to: ""/system/data-management/resource-groups/RG004"",
                children: [
  ...
  {
    id: ""P003"", label: ""Warehouse Plant"", icon: Factory, type: ""plant"",
    subtitle: ""Warehouse 1 · 1 line · 6 resources (inactive)"", loadPct: 0,
...
function TreeNodeRow({ node, depth = 0 }: { node: TreeNode; depth?: number }) {
  ...
  return (
    <div className={node.isBottleneck ? ""border-l-2 border-l-red-400 pl-2 ml-0"" : """">
      <div
        className={""flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 transition-colors hover:bg-slate-50 active:scale-[0.99] "" + (depth === 0 ? ""font-semibold"" : """")}
    ...
    <div className=""flex h-full flex-col overflow-hidden"" style={{ minHeight: 0 }}>
      <header className=""flex shrink-0 items-center gap-4 border-b border-[var(--border-soft)] bg-[var(--surface-1)] px-5 py-3"">
        ...
        <div className=""min-w-0 flex-1"">
          ...
          <p className=""text-xs text-[var(--text-secondary)]"">Hierarchical view with live load, utilization, and bottleneck detection.</p>
        </div>
      ...
      <div className=""flex-1 overflow-y-auto bg-[var(--page-bg)] p-4"">
        ...
        <AlertBanner message=""Bottleneck detected: C2-Cylinder Assembly at 94% · Welding Station 2 at 94%"" cta=""View in Control Tower"" ctaOnClick={() => navigate(""/control-tower?bottleneck=true"")} />
        ...
        <div className=""mb-3 flex flex-wrap items-center gap-3 text-[10px] text-slate-500"">
          ...
          <span className=""ml-2 flex items-center gap-1""><span className=""inline-block h-2.5 w-2.5 rounded border-l-2 border-l-red-400 bg-slate-100"" /> Bottleneck</span>
        </div>
