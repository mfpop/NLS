    ...
    items: [
      {
        ...
        items: [
          ...
          { type: "item", label: "Plants", to: "/system/production-structure/components/plants", icon: Activity },
          { type: "item", label: "Departments", to: "/system/production-structure/components/dept", icon: Shield },
          { type: "item", label: "Resource Groups", to: "/system/production-structure/components/rg", icon: Users },
          { type: "item", label: "Resources", to: "/system/production-structure/components/resource", icon: ListChecks },
        ],
      },
