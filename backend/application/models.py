...
class ImportSourceConfig(TimeStampedModel):
    ...
    path = models.CharField(max_length=512, help_text="Relative path under erp_data/source/")
    file_pattern = models.CharField(max_length=120)
    pattern_path = models.CharField(max_length=512, blank=True, default="", help_text="Optional template file path under erp_data/patterns/")
    ...
    mapping_profile_path = models.CharField(max_length=512, blank=True, default="", help_text="Mapping profile path under erp_data/structure/")
