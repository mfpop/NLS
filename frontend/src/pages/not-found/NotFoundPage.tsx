...
export function NotFoundPage() {
  return (
    <main className="flex h-full items-center justify-center bg-[var(--page-bg)] p-6" style={{ minHeight: 0 }}>
      <section className="not-found-card w-full max-w-3xl rounded-2xl border border-[var(--border-soft)] bg-[var(--surface-1)] p-8 shadow-sm">
        {/* Route gap badge */}
        ...
        {/* 404 Heading */}
        <div className="mt-5">
          <h1 className="text-5xl font-black tracking-tight text-[var(--text-primary)]">404</h1>
          <h2 className="mt-2 text-2xl font-bold text-[var(--text-primary)]">Flow interrupted</h2>
        ...
        <div className="mt-6 grid grid-cols-[1fr_auto_1fr] items-center gap-3">
          <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 text-center">
            ...
            <div className="text-sm font-semibold text-[var(--text-primary)]">LeanSynk</div>
          </div>
          ...
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-3 text-center">
            ...
            <div className="text-sm font-semibold text-[var(--text-primary)]">Control Tower</div>
          </div>
        </div>
        ...
        {/* Diagnostic footer */}
        <div className="mt-6 rounded-xl bg-[var(--surface-2)] p-3 text-xs text-[var(--text-secondary)]">
