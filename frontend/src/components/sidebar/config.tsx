    ...
    items: [
      {
        ...
        items: [
          ...
          { type: "item", label: "Plants", to: "/system/production-structure/plants", icon: Activity },
          { type: "item", label: "Departments", to: "/system/production-structure/departments", icon: Shield },
          { type: "item", label: "Resource Groups", to: "/system/production-structure/resource-groups", icon: Users },
          { type: "item", label: "Resources", to: "/system/production-structure/resources", icon: ListChecks },
        ],
      },
