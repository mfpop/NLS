...
class ManufacturingMutation:
    ...
    def install_default_production_control_audit_templates(self, info: Info) -> "AuditInstallTemplatesPayload":
        ...
        try:
            created_count = len(AuditTemplateService.install_default_production_control_templates())
            return AuditInstallTemplatesPayload(ok=True, message=f"Installed {created_count} default production control audit templates")
        except Exception as e:
    ...
    def install_default_safety_control_audit_templates(self, info: Info) -> "AuditInstallTemplatesPayload":
        ...
        from manufacturing.domain.audit_service import AuditTemplateService
        try:
            created_count = len(AuditTemplateService.install_default_safety_control_templates())
            return AuditInstallTemplatesPayload(ok=True, message=f"Installed {created_count} default safety control audit templates")
        except Exception as e:
            return AuditInstallTemplatesPayload(ok=False, message=str(e))
    ...
    def install_default_material_control_audit_templates(self, info: Info) -> "AuditInstallTemplatesPayload":
        ...
        from manufacturing.domain.audit_service import AuditTemplateService
        try:
            created_count = len(AuditTemplateService.install_default_material_control_templates())
            return AuditInstallTemplatesPayload(ok=True, message=f"Installed {created_count} default material control audit templates")
        except Exception as e:
            return AuditInstallTemplatesPayload(ok=False, message=str(e))
    ...
    def install_default_quality_control_audit_templates(self, info: Info) -> "AuditInstallTemplatesPayload":
        ...
        from manufacturing.domain.audit_service import AuditTemplateService
        try:
            created_count = len(AuditTemplateService.install_default_quality_control_templates())
            return AuditInstallTemplatesPayload(ok=True, message=f"Installed {created_count} default quality control audit templates")
        except Exception as e:
            return AuditInstallTemplatesPayload(ok=False, message=str(e))
