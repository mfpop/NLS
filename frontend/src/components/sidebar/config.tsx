    ...
    items: [
      {
        ...
        items: [
          ...
          { type: "item", label: "Company", to: "/system/production-structure/components", icon: Layers },
          { type: "item", label: "Plants", to: "/system/production-structure/components?tab=plants", icon: Activity },
          { type: "item", label: "Departments", to: "/system/production-structure/components?tab=dept", icon: Shield },
          { type: "item", label: "Resource Groups", to: "/system/production-structure/components?tab=rg", icon: Users },
          { type: "item", label: "Resources", to: "/system/production-structure/components?tab=resource", icon: ListChecks },
        ],
      },
